...
- Extension activation failure on fresh install: replaced tsc-only build with esbuild bundler that inlines all npm dependencies into `dist/extension.js`; Resolves [Issue #26](https://github.com/divisionseven/unified-kanban/issues/26)
